...
def play():
    ...
    while True:
        ...
        question, correct_answer, accepted_answers = get_random_question()
...
def show_stats(question_number, n_of_correct_answers, total_n_of_questions):
    print(
        STRINGS_DICTIONARY.stats.format(
            question_number, n_of_correct_answers, total_n_of_questions
        )
    )
